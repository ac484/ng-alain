...
function getResponsePromise(stream, apiSettings) {
  return __async(this, null, function* () {
    const allResponses = [];
...
function generateContent(apiSettings, model, params, requestOptions) {
  return __async(this, null, function* () {
    ...
    const generateContentResponse = yield processGenerateContentResponse(response, apiSettings);
...
function processGenerateContentResponse(response, apiSettings) {
  return __async(this, null, function* () {
    const responseJson = yield response.json();
    if (apiSettings.backend.backendType === BackendType.GOOGLE_AI) {
...
function countTokens(apiSettings, model, params, requestOptions) {
  return __async(this, null, function* () {
    ...
    const response = yield makeRequest(model, Task.COUNT_TOKENS, apiSettings, false, body, requestOptions);
...
var ImagenModel = class extends AIModel {
   ...
   * If all images are filtered, the `images` array will be empty.
   */
  generateImagesGCS(prompt, gcsURI) {
    return __async(this, null, function* () {
...
var getAI2 = ɵzoneWrap(getAI, true);
var getGenerativeModel2 = ɵzoneWrap(getGenerativeModel, true);
var getImagenModel2 = ɵzoneWrap(getImagenModel, true);
...
export {
  ...
  getImagenModel2 as getImagenModel,
