...
import { collection, doc, getDocs, getDoc, runTransaction, serverTimestamp, Timestamp } from '@angular/fire/firestore';
import { HubCrudService } from '../../../core/services';
import { ContractPayment, ContractPaymentStep, PaymentStatus, StepStatus } from '../models';
...
export class ContractPaymentService {
    ...
    async add(contractId: string, amount: number, remark: string = '', clientId: string): Promise<string> {
        ...
        const paymentData: ContractPayment = {
            key: paymentId,
            contractId,
            amount,
