...
import { WeatherComponent } from './widgets/weather.component';
  ...
  template: `
    <layout-default [options]="options" [asideUser]="asideUserTpl" [content]="contentTpl" [customError]="null">
      <layout-default-header-item direction="left">
        <a layout-default-header-item-trigger href="//github.com/ac484/ng-alain" target="_blank">
